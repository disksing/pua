...
export function createPUAAppChannels(): PUAAppChannels {
  return {
    ...
    agentHeader: createModelChannel<AgentPanelHeaderModel>({ identity: "", workspaceId: "", resourceId: "", status: null, submitting: false, agentName: "Agent", nextAgentName: "", errorText: "", retryAt: "", modelSummary: "", turnNumber: 0, turnStartedAt: "" }),
