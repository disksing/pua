...
<aside id="mobileSidebar" class="sidebar">
  ...
  <ActivityPanel activity={model.activity} inbox={model.inbox} onSelect={model.onSelectResource} onOpenInboxMessage={model.onOpenInboxMessage} onReplyInboxMessage={model.onReplyInboxMessage} onDeleteInboxMessage={model.onDeleteInboxMessage} onToast={model.onToast} />
</aside>
